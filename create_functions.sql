DELIMITER |
CREATE FUNCTION function_get_nomenclature_id(product_id INT) RETURNS INT
    DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION function_get_receipt_total_price(receipt_id INT) RETURNS DOUBLE
    DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION function_get_order_total_price(order_id INT) RETURNS DOUBLE
    DETERMINISTIC
BEGIN
    DECLARE price DOUBLE DEFAULT 0.0;
    SELECT total_price
...
DELIMITER |
CREATE FUNCTION function_get_nomenclature_price(nomenclature_id INT) RETURNS DOUBLE
    DETERMINISTIC
BEGIN
    DECLARE price DOUBLE DEFAULT 0.0;
    SELECT sell_price
...
DELIMITER |
CREATE FUNCTION function_get_client_discount(client_id INT) RETURNS INT
    DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION function_get_receipt_item_amount(item_id INT) RETURNS INT
    DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION function_get_order_item_amount(item_id INT) RETURNS INT
    DETERMINISTIC
BEGIN
    DECLARE sold_amount INT DEFAULT 0;
